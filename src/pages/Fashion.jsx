  ...
  useEffect(() => {
    if (fashionItems.length > 0) {
      ...
      if (selectedCategory === "All") {
        setFilteredItems(fashionOnly);
      } else {
        const filtered = fashionOnly.filter(item => 
...
console.log(selectedCategory);
  ...
  if (isLoadingProducts) return <LoadingWrapper>Loading fashion items...</LoadingWrapper>;
  ...
  return (
    <FashionWrapper>
      <PageHeader>
        ...
        <Subtitle>Discover our curated collection of trendy fashion items</Subtitle>
      </PageHeader>

      <CategoryNav>
        {["All", "Men", "Women", "Kids", "Footwear", "Others"].map(category => (
          <CategoryButton 
            key={category}
