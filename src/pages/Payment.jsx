...
import { orderviewOneAPI } from "../services/orderServices";
...
console.log(orderId);
  ...
  const { data: orderData } = useQuery({
    queryKey: ['order-data'],
    queryFn: ()=>orderviewOneAPI(orderId),
  });
      ...
      <PaymentContainer>
        ...
        <PaymentGrid>
          ...
          <PaymentForm>
            ...
            <ShippingDetails>
            <p>{orders.name || "N/A"}</p>
<p>Address: {orders.address || "N/A"}</p>
<p>{orders.city || "N/A"}, {orders.pincode || "N/A"}</p>
<p>Phone: {orders.contact || "N/A"}</p>
{/* <p>Email: {orders.email || "N/A"}</p> */}
